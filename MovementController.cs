...
public class MovementController : MonoBehaviour 
{
    ...
    void UpdateInputs()
    {
        ...
        if (Input.GetKey(KeyCode.Mouse1) ||AimingTestBool == true)
        {
            if (WM.CheckIfHoldingWeapon() == true)
            {
                ...
                if (gameObject.GetComponent<AimIK>().solver.IKPositionWeight < 1)
                {
                    gameObject.GetComponent<AimIK>().solver.IKPositionWeight += AimTransitionSpeed * Time.deltaTime;
                }
            ...
            else
            {
                ...
                if (gameObject.GetComponent<AimIK>().solver.IKPositionWeight > 0)
                {
                    gameObject.GetComponent<AimIK>().solver.IKPositionWeight -= AimTransitionSpeed * Time.deltaTime;
                }
                if (gameObject.GetComponent<AimIK>().solver.IKPositionWeight <= 0)
                {
                    MainCamAcess.GetComponent<CameraCont>().Aiming = false;
                }
            }
        }
        else
    ...
    {
        gameObject.GetComponent<FullBodyBipedIK>().solver.leftHandEffector.positionWeight = gameObject.GetComponent<AimIK>().solver.IKPositionWeight;
        gameObject.GetComponent<FullBodyBipedIK>().solver.leftHandEffector.rotationWeight = gameObject.GetComponent<AimIK>().solver.IKPositionWeight;
        gameObject.GetComponent<FullBodyBipedIK>().solver.leftArmMapping.weight = gameObject.GetComponent<AimIK>().solver.IKPositionWeight;
    }
    ...
    void FixedUpdateAnimator()
    {
        ...
        if (gameObject.GetComponent<AimIK>().solver.IKPositionWeight < 0)
        {
            gameObject.GetComponent<AimIK>().solver.IKPositionWeight = 0;
        }
        if (gameObject.GetComponent<AimIK>().solver.IKPositionWeight > 1)
        {
            gameObject.GetComponent<AimIK>().solver.IKPositionWeight = 1;
        }
    }
