...
//[ZppixFix]using UnityStandardAssets.ImageEffects;
...
public class PauseMenu : MonoBehaviour 
{
	...
	void Update () 
	{
        ...
        //[ZppixFix]SunShafts SS = MainCam.transform.gameObject.GetComponent<SunShafts>();
        Toggle SST = SunShaftsToggler.transform.gameObject.GetComponent<Toggle>();
		if (SST.isOn == true) 
		{
            //[ZppixFix]SS.enabled = true;
        }
        else
		{
            //[ZppixFix]SS.enabled = false;
        }
        //[ZppixFix]SENaturalBloomAndDirtyLens NBAL = MainCam.transform.gameObject.GetComponent<SENaturalBloomAndDirtyLens>();
        Toggle NBALT = NaturalBloomAndLensToggler.transform.gameObject.GetComponent<Toggle>();
		if (NBALT.isOn == true)
		{
            //[ZppixFix]NBAL.enabled = true;
        }
        else
		{
            //[ZppixFix]NBAL.enabled = false;
        }
